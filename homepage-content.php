<?php
/**
 * Template part: Afrobass homepage content
 *
 * Reusable on any page. Pulls ACF fields from the current page
 * (or the static front page). Include with:
...
// ACF fields (falls back to sensible defaults so the template renders anywhere).
